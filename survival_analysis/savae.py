...
from validation import obtain_c_index, bern_conf_interval,plot_model_losses
...
class SAVAE(VariationalAutoencoder):
    ...
    def fit(self, data, train_params):
        ...
        for epoch in range(train_params['n_epochs']):
            ...
            #plot_model_losses(train_losses, valid_losses, '/home/nikhil/NORA/savae-main/survival_analysis/Figure.png', 'loss')
